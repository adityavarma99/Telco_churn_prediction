...
#from src.pipeline.train_pipeline import start_pipeline  # Importing train pipeline
#from src.pipeline.predict_pipeline import predict  # Importing predict pipeline
...
if __name__ == "__main__":
        try:
            ...
            PredictPipeline(input_data_path=input_data_path, output_file_path=output_file_path)
